"""
Django settings for new_prd_dev_67568 project.
...
ROOT_URLCONF = 'new_prd_dev_67568.urls'
...
WSGI_APPLICATION = 'new_prd_dev_67568.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_prd_dev_67568 API",
    "DESCRIPTION": "API documentation for new_prd_dev_67568 App",
    "VERSION": "v1",
}
